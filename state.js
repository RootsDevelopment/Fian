...
let boardInsatnce = new Board(["rnbqkbnr/8/8/8/8/8/8/RNBQKBNR", "w", "KQkq", "-", "0", "1"]);
boardInsatnce.setBoard() ;

const piece =  boardInsatnce.getPiece(0,0);
const moves = piece.getMoves(boardInsatnce,0,0);
